---
title: Text
description: "Semantic text component built on Box for body copy, labels, and captions with size, weight, color, and truncation props."
---
...
<StorybookLink storyId="components-text--basic">
  Open in Storybook
</StorybookLink>
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <StorybookEmbed
      storyId="components-text--basic"
      title="Tosui Text basic story"
      height={180}
    />
  </TabItem>
