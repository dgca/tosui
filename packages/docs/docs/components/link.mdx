---
title: Link
description: "Styled anchor element with variants for different use cases."
---
...
<StorybookLink storyId="components-link--basic">
  Open in Storybook
</StorybookLink>
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <StorybookEmbed
      storyId="components-link--basic"
      title="Tosui link basic story"
      height={220}
    />
  </TabItem>
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <VStack as="nav" gap={2} align="start">
      <Link href="#">Home</Link>
