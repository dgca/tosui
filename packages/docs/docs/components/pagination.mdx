---
title: Pagination
description: "Navigation for paginated content with page numbers, previous/next buttons, and ellipsis for large ranges."
---
...
Pass `page` when application state or data loading controls the current page.
