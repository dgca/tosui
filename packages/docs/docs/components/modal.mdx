---
title: Modal
description: "Dialog overlay component for focused interactions requiring user attention, with sizes and focus trapping."
---
...
<StorybookLink storyId="components-modal--basic">
  Open in Storybook
</StorybookLink>
...
- `Modal` does not currently expose an accessible-name prop for the dialog.
