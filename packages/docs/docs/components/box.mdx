---
title: Box
description: "Foundational layout primitive with comprehensive styling props for spacing, colors, borders, flexbox, grid, and more. Polymorphic via the as prop."
---
