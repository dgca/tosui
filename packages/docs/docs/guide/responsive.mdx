...
Layout components ([Stack](/docs/components/stack), [HStack](/docs/components/hstack), [VStack](/docs/components/vstack), [Flex](/docs/components/flex), [Grid](/docs/components/grid)) accept responsive values on their convenience props — not just on inherited Box props.
...
- **Stack** — `direction`, `align`, `justify`, `wrap`, `gap`
- **HStack / VStack** — `align`, `justify`, `wrap`, `gap`
- **Flex** — `direction`, `align`, `justify`, `wrap`, `alignSelf`, `gap`
- **Grid** — `columns`, `rows`, `justify`, `align`, `justifyContent`, `alignContent`, `gap`
