---
title: Spacing
description: "Use Tosui's multiplier-based spacing props and 4px base unit."
---

# Spacing

Tosui calculates spacing from a 4px base unit.
...
Breakpoints use a mobile-first cascade. Specify a breakpoint only when the value changes. See the [Responsive guide](/docs/guide/responsive) for more details.
